...
def data_process(config):
    ...
    raw_val_path = os.path.join(base_path, 'dev.xml')
    ...
    # with open(os.path.join(base_path, 'processed/word2index.pickle'), 'rb') as f:
    #     word2index = pickle.load(f)
    # if not os.path.exists(os.path.join(base_path, 'processed')):
    #     os.makedirs(os.path.join(base_path, 'processed'))
    if mode == 'term':
        save_term_data(train_data, word2index, os.path.join(base_path, 'processed/train_xlnet.npz'))
        save_term_data(val_data, word2index, os.path.join(base_path, 'processed/val_xlnet.npz'))
        save_term_data(test_data, word2index, os.path.join(base_path, 'processed/test_xlnet.npz'))
    else:
        save_category_data(train_data, word2index, os.path.join(base_path, 'processed/train_xlnet.npz'))
        save_category_data(val_data, word2index, os.path.join(base_path, 'processed/val_xlnet.npz'))
        save_category_data(test_data, word2index, os.path.join(base_path, 'processed/test_xlnet.npz'))
    ...
    np.save(os.path.join(base_path, 'processed/sentiment_matrix1.npy'), sentiment_matrix)
    ...
    with open(os.path.join(base_path, 'log/log1.yml'), 'w') as handle:
